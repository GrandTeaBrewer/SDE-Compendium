...
! function(t, i) {
    ...
    function s(s, e) {
        ...
        var o = this;
        this.items.addClass("colio-item"), this.markup = t('<div class="colio"></div>'), this.markup.append('<div class="colio-container"></div>'), this.settings.navigation && (this.markup.addClass("colio-has-navigation"), t('<div class="colio-navigation"></div>').append('<a class="colio-prev btn btn-primary waves-effect waves-light" href="#">' + this.settings.prevText + "</a>").append('<a class="colio-next btn btn-primary waves-effect waves-light" href="#">' + this.settings.nextText + "</a>").appendTo(this.markup)), this.markup.append('<div class="colio-navend"><a class="colio-close btn btn-primary waves-effect waves-light" href="#">' + this.settings.closeText + "</a></div>"), "after" === this.settings.placement ? this.list.after(this.markup) : "inside" === this.settings.placement ? (this.markup.css({
            position: "absolute",
            top: 0,
            left: 0
