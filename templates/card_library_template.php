...
echo '<div id="'. $item["ID"] .'" data-content="./templates/card_library_colio_template.php?var1='. $item["ID"] . '&var2=' . $card_type . '" class="charProfile charImg heroFilter expanded-list' . ' ' .$item["Release_Code"] . ' ' .$item["Retail_Code"] .' theme'. preg_replace('/\s+/', '', $item["Theme"]) . '"><a ID="' .$item["ID"] . '" class="colio-link colioTmp" href="#" onClick="ga(\'send\', \'event\', \'colio-expand\', \'view\', \''. $item["Name_Long"] .'\')" ><img src="' .$item["Image_Path"] . '_icon.jpg" alt="" class="charPicture img-thumbnail img-fluid" data-toggle="tooltip" data-placement="bottom" title="' .$item["Name_Long"] . '" />' .$item["Name_Long"] . '</a></div>';
